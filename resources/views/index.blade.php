...
@endsection
@section('content')
@include('include.export-import-archive')
    <!-- row -->
        ...
        <div class="col-lg-12 col-xl-5">
            <div class="card">
                <div class="" style="text-align: center">
                    <img src="https://i.pinimg.com/originals/d7/ae/01/d7ae0170d3d5ffcbaa7f02fdda387a3b.gif" alt=""
                    ...
                    <table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
                        ...
                        <tbody>
                            ...
                            @foreach ($imports as $item)
                                <tr>
                                    <td class="tx-right tx-medium tx-success">{{ number_format($item->amount, 2) }} EGP
                                    </td>
                    ...
                    <table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
                        ...
                        <tbody>
                            ...
                            @foreach ($exports as $item)
                                <tr>
                                    <td class="tx-right tx-medium tx-danger">{{ number_format($item->amount, 2) }} EGP
                                    </td>
                                    <td class="tx-right tx-medium tx-inverse">{{ $item->reason }}</td>
                                </tr>
                            @endforeach
